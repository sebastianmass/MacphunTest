...
{
    PictureViewController *pVC = [[PictureViewController alloc] initWithPhoto:image];
    UIImagePickerController *pickerVC = (UIImagePickerController *)self.window.rootViewController;
    [pickerVC pushViewController:pVC animated:YES];
}
